...
const AuthPage = () => {
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center">
          <Motion.h1
            ...
            animate={{ scale: [1, 1.05, 1] }} // Breathing animation retained
      ...
      <div className="relative z-10 w-full md:w-1/2 flex justify-center md:justify-end items-center md:min-h-screen">
        <AuthForm />
      </div>
    </div>
  );
